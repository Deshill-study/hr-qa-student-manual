# 🚀 RAG + LLM 本地知识库问答系统
# Local Knowledge Base QA with RAG and LLM

基于 RAG（检索增强生成）和 LLM（大语言模型）的本地知识库问答系统
支持 PDF/Markdown 文档智能检索与问答 | 私有化部署 | Gradio 交互界面
## 🌟 功能特性

- 🤖 **智能问答**：基于 RAG 技术，准确回答文档相关问题
